...
//    public static String syncGatewayEndpoint = "ws://peplzz00107.corp.pep.pvt:7778";
    public static String syncGatewayEndpoint = "ws://172.20.21.128:4984";
    ...
    // end::stopAllReplicationForCurrentUser[]
    {
        ...
        replicator.stop();
        Log.i("Amrish","replicator is: " + replicator.getStatus());
        // end::replicationstop[]
    }
